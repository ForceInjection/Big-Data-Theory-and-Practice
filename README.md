...
- **第一讲**:
  ...
  - 参考资料
    - [大数据发展历史](./courses/chapter01/参考资料/大数据发展历史.md)
...
- **第二讲**：
  ...
  - [分布式系统概述](./courses/chapter02/1.%20分布式系统概述.pptx)
  - [Chubby 分布式锁服务](./courses/chapter02/2.%20Chubby%20分布式锁服务.pptx)
  - [Basic Paxos 两阶段共识流程全解析](./courses/chapter02/3.%20Basic%20Paxos%20两阶段共识流程全解析.pdf)
  - [ZooKeeper Leader 选举机制详解](./courses/chapter02/4.%20ZooKeeper%20Leader%20选举机制详解.pptx)

- **第三讲**：

  - [分布式文件系统 HDFS（上）](./courses/chapter03/第03讲-分布式文件系统HDFS（上）.pdf)
  - [Google File System (GFS)](<./courses/chapter03/Google%20File%20System%20(GFS)%20-%20大规模分布式存储系统的设计与实现.pptx>)
  - [HDFS 分布式文件系统原理与架构](./courses/chapter03/HDFS%20分布式文件系统原理与架构.pptx)
  - [补充：GFS-大数据存储的奠基者](./courses/chapter03/参考资料/GFS.md)

- **第四讲**：

  - [分布式文件系统 HDFS（下）](./courses/chapter04/第03讲-分布式文件系统HDFS（下）.pdf)
  - [HDFS 分布式文件系统复习](./courses/chapter04/HDFS%20分布式文件系统复习.pptx)
...
- **第五讲**：
  ...
  - [MapReduce 分布式计算框架](./courses/chapter05/第04讲-分布式计算框架MapReduce.pdf)
  - [MapReduce 核心原理](./courses/chapter05/map-reduce.md)
  - [MapReduce 幻灯片](./courses/chapter05/MapReduce%20分布式计算框架.pptx)
  - [学生使用指南](./courses/chapter05/student-guide.md)

- **第六讲**：

  - [分布式资源管理系统 YARN](./courses/chapter06/第05讲-分布式资源管理系统YARN.pdf)
  - [YARN 分布式资源管理与调度](./courses/chapter06/1.%20YARN%20分布式资源管理与调度.pptx)
  - [YARN 与 Kubernetes 底层隔离技术深度分析](./courses/chapter06/YARN-Kubernetes-底层隔离技术深度分析.md)
  - [从 Linux 内核到应用层：YARN 与 Kubernetes 资源隔离技术全栈解析](./courses/chapter06/2.%20从Linux内核到应用层_YARN与Kubernetes资源隔离技术全栈解析.pptx)
  - [练习 2：YARN 资源管理实践](./courses/chapter06/excerise_2/)

- **第七讲**：

  - [分布式计算框架 Spark](./courses/chapter07/第06讲-分布式计算框架Spark.pdf)
  - [Apache Spark 设计与实现](./courses/chapter07/Apache%20Spark%20设计与实现.md)
  - [Spark 3.5 演示项目](./courses/chapter07/spark-3.5-demo/)

- **第八讲**:

  - [数据仓库开发工具 Hive](./courses/chapter08/第07讲-数据仓库开发工具Hive.pdf)
...
- **第九讲**:
  ...
  - [分布式 NoSQL 数据库 HBase](./courses/chapter09/第08讲-分布式NoSQL数据库HBase.pdf)
  - [HBase 设计与实现](./courses/chapter09/HBase%20设计与实现.md)
  - [HBase 设计与实现 PPT](./courses/chapter09/3.%20HBase%20设计与实现.pptx)
  - [Bigtable 论文详解](./courses/chapter09/Bigtable论文详解.md)
  - [Bigtable 论文详解 PPT](./courses/chapter09/1.%20Bigtable论文详解.pptx)
  - [LSM-Tree 入门 PPT](./courses/chapter09/2.%20LSM-Tree%20入门.pptx)
  - [Feed 流系统架构演进综述](./courses/chapter09/feed_stream_architecture_review.md)
  - [LSM-Tree 实践项目](./courses/chapter09/java-lsm-tree/)

- **第十讲**：

  - [分布式消息队列 Kafka](./courses/chapter10/第09讲-分布式消息队列Kafka.pdf)
  - [Kafka 设计与实现](./courses/chapter10/Kafka%20设计与实现.md)
  - [Kafka 设计与实现 PPT](./courses/chapter10/1.%20Kafka设计与实现.pptx)
  - [Kafka 日志收集架构设计案例](./courses/chapter10/Kafka%20日志收集架构设计案例.md)
  - [Kafka 实践示例](./courses/chapter10/examples/README.md)

- **第十一讲**：

  - [分布式数据采集工具 Flume](./courses/chapter11/第10讲-分布式数据采集工具Flume.pdf)
  - [分布式流处理框架 Flink](./courses/chapter11/第11讲-分布式流处理框架Flink.pdf)
  - [Flink 设计与实现](./courses/chapter11/Flink%20设计与实现.md)
  - [Flink 设计与实现 PPT](./courses/chapter11/2.%20Flink%20设计与实现.pptx)
  - [从 ETL 到流式计算入门](./courses/chapter11/从ETL到流式计算入门.md)
  - [从 ETL 到流式计算入门 PPT](./courses/chapter11/1.%20从ETL到流式计算入门.pptx)
  - [Lambda 与 Kappa 架构](./courses/chapter11/Lambda_and_Kappa_Architecture.md)
  - [State 与容错机制直观解释](./courses/chapter11/State与容错机制直观解释.md)
  - [Watermark 直观解释与示例](./courses/chapter11/Watermark%20直观解释与示例.md)
  - [Window 机制与 Watermark 协同详解](./courses/chapter11/Window机制与Watermark协同详解.md)
  - [流式计算动手实践系列](./courses/chapter11/hands-on-streaming/README.md)

- **第十二讲**：

  - [数据仓库与数据集市概述](./courses/chapter12/第12讲-数据仓库与数据集市概述.pdf)
  - [数据湖概述](./courses/chapter12/第13讲-数据湖概述.pdf)
  - [从数据仓库到数据湖](./courses/chapter12/从数据仓库到数据湖.md)
  - [数仓分层架构详解](./courses/chapter12/1.%20数仓分层架构详解.pptx)
  - [数仓分层架构详解 (文档)](./courses/chapter12/辅助材料/数仓分层架构详解.md)
  - [Table Format 技术详解](./courses/chapter12/2.%20Table_Format技术详解.pptx)
  - [Table Format 技术详解 (文档)](./courses/chapter12/辅助材料/Table_Format_技术详解.md)
  - [Iceberg 核心机制深度剖析](./courses/chapter12/3.%20Iceberg核心机制深度剖析.pptx)
  - [Iceberg 核心机制深度剖析 (文档)](./courses/chapter12/辅助材料/Iceberg_核心机制深度剖析.md)
  - [从数据仓库到湖仓一体](./courses/chapter12/4.%20从数据仓库到湖仓一体.pptx)
